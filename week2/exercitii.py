...
#  item = 1
#  lista = [1, 2, 3]
#  for x, y in enumerate(lista):    x este indexul, y este elementul coresp
#    item *= x
#    print(lista[y+1])
#    break   break ca sa se operasca dupa x=2
...
"""9"""
# test_dict = {"element": 1, "element2": 3, "element3": 2}
...
# print(param_list)   inlocuieste nr de la indexul 0
